...
public class ModItems {
    ...
    public static final RegistryObject<Item> ABYSSAL_SWORD = ITEMS.register("abyssal_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> BEJEWELED_SWORD = ITEMS.register("bejeweled_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> BLACK_SWORD = ITEMS.register("black_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> BLAZE_SWORD = ITEMS.register("blaze_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> BLUE_GRADIENT_SWORD = ITEMS.register("blue_gradient_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> BLUE_SWORD = ITEMS.register("blue_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> COOKED_SWORDFISH = ITEMS.register("cooked_swordfish", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> ETHERIAL_SWORD = ITEMS.register("etherial_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> FRILL_SWORD = ITEMS.register("frill_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> FROZEN_SWORD = ITEMS.register("frozen_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> GILDED_SWORD = ITEMS.register("gilded_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> GREEN_SWORD = ITEMS.register("green_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> HYBRID_AXE = ITEMS.register("hybrid_axe", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> KHOPESH = ITEMS.register("khopesh", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> LIME_SWORD = ITEMS.register("lime_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MAGMA_SWORD = ITEMS.register("magma_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_BATTLESTAFF = ITEMS.register("manas_battlestaff", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_BRACER = ITEMS.register("manas_bracer", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_CLAWS = ITEMS.register("manas_claws", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_CLAYMORE = ITEMS.register("manas_claymore", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_DAGGER = ITEMS.register("manas_dagger", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_GLAIVE = ITEMS.register("manas_glaive", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_GREATSWORD = ITEMS.register("manas_greatsword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_HALBERD = ITEMS.register("manas_halberd", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_HAMMER = ITEMS.register("manas_hammer", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_KATANA = ITEMS.register("manas_katana", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_KNUCKLES = ITEMS.register("manas_knuckles", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_MACE = ITEMS.register("manas_mace", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_RAPIER = ITEMS.register("manas_rapier", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_SCIMITAR = ITEMS.register("manas_scimitar", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_SICKLE = ITEMS.register("manas_sickle", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_SPEAR = ITEMS.register("manas_spear", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MANAS_SWORD = ITEMS.register("manas_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> MIROS_SWORD = ITEMS.register("miros_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> OBSIDIAN_HAMMER = ITEMS.register("obsidian_hammer", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> ORANGE_SWORD = ITEMS.register("orange_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> PARROT_SWORD = ITEMS.register("parrot_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> PINK_SWORD = ITEMS.register("pink_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> PRISMARINE_SWORD = ITEMS.register("prismarine_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> PURPLE_BEAM_SWORD = ITEMS.register("purple_beam_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> PURPLE_SWORD = ITEMS.register("purple_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> RAINBOW_GRADIENT_SWORD = ITEMS.register("rainbow_gradient_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> RED_SWORD = ITEMS.register("red_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> RUSTED_SWORD = ITEMS.register("rusted_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> SALMON_SWORD = ITEMS.register("salmon_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> SLIME_SWORD = ITEMS.register("slime_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> SWORDFISH = ITEMS.register("swordfish", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> TEMS_BATTLESTAFF = ITEMS.register("tems_battlestaff", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> TUFF_SW0RD = ITEMS.register("tuff_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> YELLOW_SWORD = ITEMS.register("yellow_sword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
    public static final RegistryObject<Item> ZOE_GREATSWORD = ITEMS.register("zoe_greatsword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()));
