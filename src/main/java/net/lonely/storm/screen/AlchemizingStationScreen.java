...
import net.lonely.storm.screen.renderer.EnergyDisplayTooltipArea;
import net.lonely.storm.screen.renderer.FluidTankRenderer;
import net.lonely.storm.util.MouseUtil;
...
public class AlchemizingStationScreen extends AbstractContainerScreen<AlchemizingStationMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(StormMod.MOD_ID,"textures/gui/alchemizing_station_gui.png");

    private EnergyDisplayTooltipArea energyInfoArea;
    private FluidTankRenderer fluidRenderer;

    public AlchemizingStationScreen(AlchemizingStationMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void assignFluidRenderer() {
        fluidRenderer = new FluidTankRenderer(60000, true, 16, 36);
    }
