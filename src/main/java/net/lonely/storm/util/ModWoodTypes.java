...
//public static final WoodType BOGBIRCH = WoodType.register(new WoodType(StormMod.MOD_ID + ":bogbirch", BlockSetType.OAK));
    ...
    //public static WoodType BOGBIRCH = WoodType.register(new WoodType("bogbirch", BlockSetType.OAK));

    public static final WoodType BOGBIRCH = WoodType.register(
            new WoodType(StormMod.MOD_ID + ":bogbirch", BlockSetType.OAK)
    );
}
